...
// Ensure data directory exists - modify for Vercel
const dataDir = path.join(process.cwd(), 'data');
if (!fs.existsSync(dataDir)) {
  try {
    fs.mkdirSync(dataDir, { recursive: true });
  } catch (err) {
    console.warn('Warning: Could not create data directory. This is expected in serverless environments.');
    // In Vercel, we'll use environment variables or database instead
  }
}
...
// Modify the server start section at the end of the file
