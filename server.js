  ...
  const variables = {
    metaobject: {
      ...
      fields: [
        ...
        { key: "own_account", value: formData.ownAccount || "" },
        { key: "third_party", value: formData.thirdParty || "" },
        { key: "third_party_name", value: formData.thirdPartyName || "" },
        { key: "third_party_address", value: formData.thirdPartyAddress || "" },
